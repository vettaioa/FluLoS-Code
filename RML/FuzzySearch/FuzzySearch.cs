...
namespace FuzzySearching
{
    ...
    {
        private IReadOnlyDictionary<string, string> phoneticSubs;

        /// <summary>The constructor of the <c>FuzzySearch</c> class.</summary>
        public FuzzySearch(IReadOnlyDictionary<string, string> phoneticSubs)
        {
            this.phoneticSubs = phoneticSubs;
        }
        ...
        public IDictionary<string, string> getPhoneticSubstitutions(IEnumerable<string> data)
        {
